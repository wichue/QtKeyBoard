...
#include "../../googlepinyinTest/keyboardAll/googlepinyin.h"
...
QT_MOC_LITERAL(1, 13, 17), // "pinyinTextChanged"
QT_MOC_LITERAL(2, 31, 0) // ""

    },
    "GooglePinyin\0pinyinTextChanged\0"
};
...
void GooglePinyin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->pinyinTextChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (GooglePinyin::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GooglePinyin::pinyinTextChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GooglePinyin::pinyinTextChanged(const QString & _t1)
{
